...
// 🔹 Webhook Logs 
const LOG_WEBHOOK = new WebhookClient({ url: 'http://discord.com/api/webhooks/1417187491886272694/CyAo16QrbQftYaU0Ak-SMRlv_Wp6J_pEhrYu7dlJpfy6xrjNiYa0d4w_DkkvdG5YRTZ-' });

// 🔹 Support Server ID
const SUPPORT_SERVER_ID = "1371496371147902986";

// 🔹 Permanent Support Server Invite Link
const SUPPORT_INVITE = "https://discord.gg/HaD5sYEj8w";
...
module.exports = (client) => {
  ...
  client.on("messageCreate", async (message) => {
    ...
    if (data.expireAt && Date.now() > data.expireAt) {
      ...
      let components = [];
      // Agar support server me nahi hai to invite button bhejna hai
  ...
  function sendLog(type, userId, expireAt) {
    ...
    // Webhook par bhejo + user mention
